...
| 02 | [02-write-prompt.md](prompts/02-write-prompt.md) | "write memory" / "end memory" | End-of-session memory persistence — update all memory, plans, issues |
...
*Prompt index — v3.3.0 — 2026-04-16*
