...
>
> For CI-pipeline issues (lint, test, build matrix), see [`spec/12-cicd-pipeline-workflows/10-known-issues-and-fixes.md`](../09-pipeline/10-known-issues-and-fixes.md).
...
- [spec/12-cicd-pipeline-workflows/10-known-issues-and-fixes.md](../09-pipeline/10-known-issues-and-fixes.md) — CI-pipeline issue catalog
